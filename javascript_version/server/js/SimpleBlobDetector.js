//see https://gist.githubusercontent.com/janpaul123/8b9061d1d093ec0b36dac2230434d34a/raw/f689e70c3fb34c958f7d45693bf865b9269641f5/SimpleBlobDetector.js
...
//export default function simpleBlobDetector(image, params) { //libby - now an imagedata object
export default function simpleBlobDetector(imgData, params) {
  params = { ...defaultParams, ...params };

//  const grayScaleImage = new cv.Mat(image.rows, image.cols, cv.CV_8UC1); //libby

  const grayScaleImage = new cv.Mat(imgData.width, imgData.height, cv.CV_8UC1); //libby
  const image = new cv.matFromImageData(imgData);
